...
def execute_test(args, total_data, model,
    ...
    for batch_data in utils.make_batch(data,
        ...
        with torch.no_grad():
            ...
            sub_rank1_gen, obj_rank1_gen, cur_loss1_gen, \
            sub_rank2_gen, obj_rank2_gen, cur_loss2_gen, \
            sub_rank3_gen, obj_rank3_gen, cur_loss3_gen, \
            ce_all_acc = model(batch_data, 'Test', total_data)
            ...
            s_ranks1_gen += sub_rank1_gen
            o_ranks1_gen += obj_rank1_gen
            tmp1_gen = sub_rank1_gen + obj_rank1_gen
            all_ranks1_gen += tmp1_gen
    ...
    return s_ranks1, o_ranks1, all_ranks1, \
           ...
           s_ranks1_gen, o_ranks1_gen, all_ranks1_gen, \
           s_ranks2_gen, o_ranks2_gen, all_ranks2_gen, \
           s_ranks3_gen, o_ranks3_gen, all_ranks3_gen
